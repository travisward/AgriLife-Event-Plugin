...
function gigpress_settings() {
	...
	<table class="gp-table form-table">
		...
		<tr>
			<th scope="row"><?php _e("Full URL to your 'Upcoming Events' page", "gigpress") ?>:</th>
			<td>
				<input type="text" size="48" name="gigpress_settings[shows_page]" value="<?php echo $gpo['shows_page']; ?>" />				</td>
		</tr>	
		<tr>
			<th scope="row"><?php _e("No upcoming events message", "gigpress") ?>:</th>
			<td>
				<input type="text" name="gigpress_settings[noupcoming]" size="48" value="<?php echo $gpo['noupcoming']; ?>" />
			</td>
		</tr>	
		<tr>
			<th scope="row"><?php _e("No past events message", "gigpress") ?>:</th>
			<td>
		...
		<tr>
			<th scope="row"><?php _e("User level required to use AgriLife Events Plugin", "gigpress") ?>:</th>
			<td>
		...
		<tr>
			<th scope="row"><?php _e("Event label", "gigpress") ?>:</th>
			<td>
		...
		<tr>
			...
			<td>
				...
				<label><input type="radio" name="gigpress_settings[related_position]" value="nowhere"<?php if($gpo['related_position'] == "nowhere") echo(' checked="checked"'); ?> /> <?php _e("using <code>[events_related]</code>", "gigpress"); ?></label></p>
		...
		<tr>
			<th scope="row"><?php _e("Related event heading", "gigpress") ?>:</th>
			<td>
		...
		<tr>
			...
			<td>
				<p><label><input type="checkbox" name="gigpress_settings[autocreate_post]" value="1"<?php if($gpo['autocreate_post'] == 1) echo(' checked="checked"'); ?> /> <?php _e("Automatically create a related post for every new event I enter.", "gigpress"); ?></label></p>
		...
		<tr>
			...
			<td>
				<p><?php _e("Place a link to each event's related post in the following fields", "gigpress"); ?> &hellip;</p>
		...
		<tr>
			...
			<td>
				...
				<span class="description"><?php _e("This appears in your events listing.", "gigpress") ?></span>
			</td>
		</tr>	
		<tr>
