...
function gigpress_import_export() {
	...
	<div class="gp-import-panel">
		...
		<p><?php _e("Upload a CSV (comma-separated values) file to import into your AgriLife Events database.", "gigpress"); ?> <a href="http://gigpress.com/docs/#import"><strong><?php _e("Please review the formatting specifications to save yourself headaches!", "gigpress"); ?></strong></a></p>
	...
	<div class="gp-export-panel">
		...
		<p><?php _e("Download your complete event database as a CSV (comma-separated values) file, compatible with programs such as Microsoft Excel. This file is also suitable to import into another AgriLife Events installation.", "gigpress"); ?></p>
		...
		<form action="admin-post.php" method="post">
			...
			<div style="margin-bottom:5px;">
				<select name="artist_id">
					<option value="-1"><?php _e("Export all events", "gigpress"); ?></option>
				...
				if($artistdata) {
					...
					echo('<option value="-1">' . __("No events in the database", "gigpress") . '</option>');
				}
				?>
				</select>
			</div>
			<div style="margin-bottom:5px;">	
				<select name="tour_id">
					<option value="-1"><?php _e("Export all series", "gigpress"); ?></option>
				...
				if($tourdata) {
					...
					echo('<option value="-1">' . __("No series in the database", "gigpress") . '</option>');
				}
				?>
				</select>
			</div>
